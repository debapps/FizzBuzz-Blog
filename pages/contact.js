        ...
        <section className="flex flex-col lg:flex-row items-center px-10">
          ...
          <article>
            <p className="py-2 font-poppins text-gray-600 text-lg md:text-xl">
              I like to hear your feedbacks and suggestions. You can also pitch
              your blog idea to me and I will publish your article with your
              name and contacts in my blog after review.
            </p>
            <p className="py-2 font-poppins text-gray-600 text-lg md:text-xl">
              Please write to me @{" "}
            ...
            <section className="flex flex-row items-center justify-self-end space-x-4 py-5 text-5xl">
              <Link
